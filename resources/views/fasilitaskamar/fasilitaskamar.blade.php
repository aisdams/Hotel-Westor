        ...
        <table class="table table-bordered dataTable table-responsive" id="fasilitas">
            <thead style="font-size: 14px"  class="table-dark">
                <tr>
                    ...
                    <th scope="col">Total Room Tersedia</th>
                    <th scope="col">Total Room unused</th>
                    <th scope="col">Total Room Used</th>
                ...
                <tr>
                    ...
                    <td style="display: flex">
                        <div class="dis d-flex">
                            ...
                            <form action="{{ url('fasilitaskamar',$item->id) }}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-icon btn-danger delete ms-1"
                                    data-name="{{ $item->fasilitashotel->namafasilitas }}"><i class="fas fa-trash"></i></button>
                            </form>
                        </div>
                    </td>
                </tr>
