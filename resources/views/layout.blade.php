...
<body>
  <div id="app">
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar" id="nav-bar navbar-color">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="{{ asset('template1/images/layout_img/user_img.jpg') }}" class="rounded-circle mr-1">
      ...
      <div class="main-sidebar" id="content">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="/main">
            <div class="d-flex mt-3 ms-3">
              <img src="https://img.freepik.com/premium-vector/vector-illustration-cute-lion-chibi-animal_602089-1023.jpg?w=740" width="80px" style="border-radius:170px" alt="">
              <div class="d-block">
              <h6 class="mt-4 ms-3 text-white">{{ Auth::user()->username }}</h6>
              <div class="circlenya ms-2" style="width: 7px;background:rgb(0, 255, 136);border-radius:170px;height:6px;"></div>
              <p class="ms-4 text-white" style="font-size:12px;margin-top:-1rem">Online</p>
            </div>
              </div>
            </a>
          </div>
          ...
          <ul class="sidebar-menu mt-3">
              <li class="menu-header text-white fs-6 mb-2">Menu</li>
              ...
              <li class="nav-item {{ 'fasilitashotel' == request()->path() ? 'active' : '' }}">
                <a href="/fasilitashotel" class="nav-link"><i class="fa-solid fa-hotel"></i><span>Fasilitas Hotel</span></a>
              </li>
              @endif
              @if (auth()->user()->level == "admin")
              <li class="nav-item {{ 'fasilitaskamar' == request()->path() ? 'active' : '' }}">
                <a href="/fasilitaskamar" class="nav-link"><i class="fa-regular fa-hospital"></i><span>Fasilitas Kamar</span></a>
              </li>
              @endif
              @if (auth()->user()->level == "admin")
              <li class="nav-item {{ 'checkpemesanan' == request()->path() ? 'active' : '' }}">
                <a href="/checkpemesanan" class="nav-link"><i class="fa-solid fa-book-bookmark"></i><span>Data Pemesanan</span></a>
              </li>
              @endif
              @if (auth()->user()->level == "resepsionis")
              <li class="nav-item {{ 'dataresepsionis' == request()->path() ? 'active' : '' }}">
                <a href="/dataresepsionis" class="nav-link"><i class="fa-solid fa-book-open-reader"></i><span>Data Pemesanan</span></a>
              </li>
              @endif
            </div>
        </aside>
